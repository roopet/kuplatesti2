class BubbleChart
  constructor: (data) ->
    ...
    @group_centers = {
      "Matkailu": {x: 300, y: @height / 4},
      "Yritysten toimintaympÃ¤ristÃ¶n kehittÃ¤minen": {x: 600, y: @height / 4},
      "Hyvinvointi": {x: 900, y: @height / 4},
      "Kivi ja kaivannais": {x: 300, y: 2 * @height / 4}
    ...
    @radius_scale = d3.scale.pow().exponent(0.5).domain([0, max_amount]).range([2, 30])
  ...
  display_groups: () =>
    groups_x = {
      "Matkailu": 300, 
      "Yritysten toimintaympÃ¤ristÃ¶n kehittÃ¤minen": 600, 
      "Hyvinvointi": 900, 
      "Kivi ja kaivannais": 300 }
    ...
    groups_y = {
      ...
      "Yritysten toimintaympÃ¤ristÃ¶n kehittÃ¤minen": @height / 4 + 50, 
  ...
  hide_groups: () =>
    ...
    this.display_organizations()

  # move all circles to their associated @organization_centers 
